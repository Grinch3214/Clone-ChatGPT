<template>
	<div class="relative">
		<textarea v-model="chatGptStore.inputData" @keypress.prevent.enter="chatGptStore.sendMessage" placeholder="Message ChatGPT..." class="border border-border bg-background placeholder:text-border w-full rounded-md p-2 pr-8 resize-none text-sm max-h-[158px] outline-none focus:shadow-border focus:shadow-border" style="height: 38px;" @input="adjustTextareaHeight"></textarea>
